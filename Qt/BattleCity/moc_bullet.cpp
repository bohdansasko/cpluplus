...
QT_MOC_LITERAL(4, 37, 25), // "signalSendTypeOfKilledBot"
QT_MOC_LITERAL(5, 63, 15) // "slotTimerBullet"

    },
    "Bullet\0signalDestroy\0\0signalGameOver\0"
    "signalSendTypeOfKilledBot\0slotTimerBullet"
};
...
void Bullet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signalSendTypeOfKilledBot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (Bullet::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bullet::signalSendTypeOfKilledBot)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 2
void Bullet::signalSendTypeOfKilledBot(QString _t1)
{
